 ...
 async function handleStripeWebhook(body: any) {
     ...
     switch (type) {
         case 'invoiceitem.deleted':
             console.log('Deleting invoice item', subId)
             return new Response(JSON.stringify({ message: "Invoice item deleted!" }), {
                 status: 200,
             });
         case "checkout.session.completed":
             ...
             console.log('Updating subscription', userId, subscriptionId, tier)
         ...
         case "customer.subscription.updated":
             ...
             console.log('Updating subscription', meta.userId, meta.tier)
             return new Response(
