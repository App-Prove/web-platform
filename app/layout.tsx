            ...
            <div className="flex items-center gap-6">
              <Link href="/">
                <svg className="dark:fill-white fill-black cursor-pointer group" width="40" height="44" viewBox="0 0 40 44" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path className="group-hover:fill-orange transition-colors" d="M38.6775 21.9468C39.2656 20.5287 39.0418 18.091 39.0418 18.091V0.906982L36.6434 2.57681V9.10433L36.5428 17.7571C36.6168 18.701 36.4308 20.8604 35.095 21.9468L19.9754 34.2428V37.37L36.6434 24.2542C36.6434 24.2542 38.1614 23.1916 38.6775 21.9468Z" />
                  <path className="fill-orange" d="M6.05135 19.6394C5.46331 18.2213 5.68704 15.7837 5.68704 15.7837V0.815918L8.08552 2.54647V6.79694L8.18604 15.4497C8.11205 16.3936 8.29804 18.5531 9.63391 19.6394L20.0362 28.8083V31.9355L8.08552 21.9468C8.08552 21.9468 6.56749 20.8842 6.05135 19.6394Z" />
                  <path className="fill-orange" d="M34.021 19.6394C34.6091 18.2212 34.3853 15.7836 34.3853 15.7836V0.846191L31.9869 2.51602V6.79686L31.8863 15.4496C31.9603 16.3935 31.7743 18.553 30.4385 19.6394L20.0362 28.8082V31.9354L31.9869 21.9468C31.9869 21.9468 33.5049 20.8841 34.021 19.6394Z" />
                </svg>
              </Link>
